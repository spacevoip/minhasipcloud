-- 032_fix_claim_contacts_ambiguous_id.sql
-- Corrige erro 42702 (ambiguous column "id") na RPC claim_contacts
-- Altera o nome da coluna de retorno para contact_id e qualifica todas as referências
